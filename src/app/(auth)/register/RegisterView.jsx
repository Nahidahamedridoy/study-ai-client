...
export default function RegisterView() {
    ...
    return (
        <div className='relative flex items-center justify-center min-h-[calc(100vh-64px)] bg-white dark:bg-gray-950 p-4 overflow-hidden'>
            ...
            <div className="absolute top-1/4 -right-20 w-72 h-72 bg-secondary-500/20 rounded-full mix-blend-multiply filter blur-3xl animate-blob"></div>
            <div className="absolute bottom-1/4 -left-20 w-72 h-72 bg-primary-500/20 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000"></div>
            ...
            >
                <div className="text-center">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm">Join StudyMate AI today</p>
                </div>

                <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
                    <div>
                        <label className='block text-sm font-semibold text-gray-900 dark:text-white mb-1.5'>Full Name</label>
                        <Input 
                            type='text' 
                            className={`w-full ${errors.name ? 'border-red-500 focus:ring-red-200 focus:border-red-500' : ''}`}
                    ...
                    <Button type="submit" disabled={isLoading} className='w-full text-base py-2.5 flex items-center justify-center gap-2 mt-2'>
                ...
                <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
                    Already have an account? <Link href="/login" className="font-semibold text-primary-600 dark:text-primary-400 hover:underline">Sign in</Link>
                </p>
            </motion.div>
        </div>
    );
